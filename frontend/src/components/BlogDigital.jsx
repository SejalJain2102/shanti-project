...
import digitalblog from "../assets/digitalblog.jpg"
...
const BlogDigital = () => {
  ...
  return (
    <>
      <div  style={{ backgroundImage: `url(${digitalblog})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }}
       className='lg:h-96 sm:h-72 h-60 flex flex-col justify-center items-center'>
        <h1 className='font-bold text-3xl sm:text-5xl text-purple-500'>Digital Blog</h1>
      ...
      <div className='mx-2 mb-4 m-4 sm:mx-24 md:mx-32 lg:mx-56 mt-20'>
        <h1 className='font-bold text-2xl sm:text-4xl'>About Digital Marketing</h1>
