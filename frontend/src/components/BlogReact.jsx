...
const BlogReact = () => {
  ...
  return (
    <>
      <div  style={{ backgroundImage: `url(${reactblog})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center" }}
      className='lg:h-96 sm:h-72 h-60 flex flex-col justify-center items-center'>
      <h1 className='font-bold text-3xl sm:text-5xl text-purple-500'>React Blog</h1>
