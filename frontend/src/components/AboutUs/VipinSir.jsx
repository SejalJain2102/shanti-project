...
const VipinSir = () => {
  useEffect(() => {
    ...
    <div className='mt-32'>
    <div  className='lg:grid grid-cols-3 grid-flow-col justify-center  gap-16 space-y-10 md:m-10 sm:m-5 m-2 sm:mx-12 md:mx-24 lg:mx-32'>
      ...
      <div className='col-span-1 flex flex-col justify-between items-center'>
        <img   src="../src/assets/VipinSir.jpeg" alt="" className='w-96 lg:w-auto' />
