     ...
     <div className='max-w-96 space-y-5'>
        ...
        <div className='grid grid-cols-6'>
          ...
          <p className='col-span-5 flex flex-col'>
            ...
            <span className='font-semibold'>Sales:<a className='font-normal' href="info@shantiinfosoft.com">info@shantiinfosoft.com
            </a></span>
            <span className='font-semibold'>Career:<a className='font-normal' href="hr@shantiinfosoft.com">hr@shantiinfosoft.com</a></span>
          </p>
        </div>
        <div className='grid grid-cols-6 '>
          ...
          <p className='col-span-5 flex flex-col'>
            ...
            <span className='font-semibold'>Sales:<span className='font-normal'> +91 9981225000</span></span>
            <span className='font-semibold '>Career:<span className='font-normal'>+91 8319974229</span></span>
        ...
        <div className='grid grid-cols-6'>
          ...
          <p className='col-span-5 flex flex-col'>
            ...
            <a href="">Plot no 70 1st & 3rd floor PU 4 Scheme, No.54, Vijay Nagar Square, Behind C21 Mall, Indore, Madhya Pradesh</a>
          </p>
        </div>
