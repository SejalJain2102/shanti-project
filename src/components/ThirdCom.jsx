...
const ThirdCom = () => {
  return (
    <div className='grid lg:grid-cols-2 sm:grid-cols-1 gap-10 mt-14 m-1 sm:mx-22 md:mx-24 lg:mx-56'>
      {/* Node.js Section */}
      <div className='border rounded-md p-5 space-y-4 h-fit'>
        ...
        <div className='space-y-2 mt-2'>
          ...
          <button className='bg-red-600 text-white font-bold rounded w-full py-1 hover:bg-red-700'>Know More</button>
        </div>
      </div>
      ...
      <div className='border rounded-md p-5 space-y-4 lg:mt-7'>
        <div className='flex items-center'>
